       ...
       77 WS-COUNT            PIC 9(1) VALUE 5.
       77 I                   PIC 9(1).
       77 WS-RUNNING-BALANCE  PIC S9(7)V99 VALUE 0.
       77 WS-AMOUNT-DISPLAY   PIC +Z,ZZ9.99.
       77 WS-BALANCE-DISPLAY  PIC +Z,ZZ9.99.
       ...
       MAIN-PARA.
           ...
           PERFORM VARYING I FROM 1 BY 1 UNTIL I > WS-COUNT
               DISPLAY "Enter transaction " I " date (DD/MM/YYYY): " WITH NO ADVANCING
               ACCEPT T-DATE OF TRANS-TAB(I)
               DISPLAY "Enter transaction " I " description: " WITH NO ADVANCING
               ACCEPT T-DESC OF TRANS-TAB(I)
               DISPLAY "Enter transaction " I " amount: " WITH NO ADVANCING
               ACCEPT T-AMT OF TRANS-TAB(I)
           END-PERFORM
