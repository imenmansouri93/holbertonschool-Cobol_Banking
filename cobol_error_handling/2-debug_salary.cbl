       ...
       MAIN-LOGIC.
               ...
               READ EMPLOYEE-FILE
                   ...
                   NOT AT END
                       IF EMP-ID-TEXT = WS-INPUT-ID
                           ...
                           COMPUTE WS-SALARY-NUM = FUNCTION NUMVAL
                           (EMP-SALARY-TEXT)
                           MOVE WS-SALARY-NUM TO WS-NEW-SALARY-DSP
                           DISPLAY "[DEBUG] Found: " FUNCTION TRIM
                           (EMP-NAME) " with salary "
                           ...
                           WS-INPUT-BONUS-TEXT
                           COMPUTE WS-BONUS-NUM = FUNCTION NUMVAL
                           (WS-INPUT-BONUS-TEXT)
           ...
           IF WS-FOUND-FLAG = 'Y'
               DISPLAY "Updated Salary for " FUNCTION TRIM
               (EMP-NAME) ": " FUNCTION TRIM(WS-NEW-SALARY-DSP)
           ELSE
